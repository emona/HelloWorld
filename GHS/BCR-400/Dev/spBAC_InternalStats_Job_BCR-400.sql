...
/****** Object:  StoredProcedure [dbo].[spBAC_InternalStats_Job]    Script Date: 10/14/2019 10:47:05 AM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Bank of America Internal Reporting
...
Select JobName, SUM(tblbac_Stat.SeedCount),
MIN(tblbac_Stat.MailDate) as 'First Mail Date', MAX(LastMailDate) as 'Last Mail Date',
(CAST((SUM(ExitScans * tblBAC_Stat.Days)) as decimal(19,9))/SUM(tblBAC_Stat.ExitScans)) as 'TravelDays',
  (CAST((SUM(ExitScans * tblBAC_stat.USPSDays)) as decimal(19,9))/SUM(tblBAC_Stat.ExitScans) ) as 'USPSDays'
from tblBAC_Stat
...
Select tblBAC_Stat.JobName, #TempStat.Seeds as 'Pieces',
...
Drop Table #TempStat2-------select * from #TempStat2
...
EXEC sys.sp_addextendedproperty @name=N'VSSComment', @value=N'This is the initial sync of the proc' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_Job'
GO

EXEC sys.sp_addextendedproperty @name=N'VSSDate', @value=N'5/25/2010' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_Job'
GO

EXEC sys.sp_addextendedproperty @name=N'VSSUserName', @value=N'Admin' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_Job'
GO

EXEC sys.sp_addextendedproperty @name=N'VSSVersionNumber', @value=N'1' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_Job'
GO
