...
/****** Object:  StoredProcedure [dbo].[spBAC_InternalStats_All]    Script Date: 10/14/2019 10:47:23 AM ******/
SET ANSI_NULLS ON
GO
...
-- Description:	Bank of America Internal Reporting at Internal Totals
-- =============================================
CREATE PROCEDURE [dbo].[spBAC_InternalStats_All]
...
Select SUM(tblbac_Stat.SeedCount),
...
into #TempStat2
from tblBAC_Stat inner join #TempStat on (MailDate >= #TempStat.FirstMailDate) and (tblBAC_Stat.LastMailDate <= #TempStat.LastMailDate)
--where Days > -1
group by   #TempStat.Seeds,
#tempStat.FirstMailDate, #tempStat.LastMailDate,
     #TempStat.TDays,
  #TempStat.USPSDays
...
--Calculate Median
Select 'ZZZGrandTotal' JobName,'GrandTotal' Job_name,'Totals'	LOB,
...
EXEC sys.sp_addextendedproperty @name=N'VSSComment', @value=N'This is the 2 version of this proc' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_All'
GO

EXEC sys.sp_addextendedproperty @name=N'VSSDate', @value=N'5/24/2010' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_All'
GO

EXEC sys.sp_addextendedproperty @name=N'VSSUserName', @value=N'Admin' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_All'
GO

EXEC sys.sp_addextendedproperty @name=N'VSSVersionNumber', @value=N'2' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'PROCEDURE',@level1name=N'spBAC_InternalStats_All'
GO
